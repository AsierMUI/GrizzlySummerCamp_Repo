...
public class Object2Terrain : EditorWindow {
    ...
    void CreateTerrain()
    {
        ...
        // Hacer raycasting para determinar las alturas del terreno
        ...
        // Establecer las alturas en el Terrain
        ...
        // Guardar el TerrainData como un asset
        SaveTerrainData(terrain);
    }
    ...
    // Función para guardar el TerrainData como un asset
    void SaveTerrainData(TerrainData terrainData)
    {
        string path = "Assets/TerrainData_" + Selection.activeGameObject.name + ".asset";

        // Crear el asset en el proyecto
